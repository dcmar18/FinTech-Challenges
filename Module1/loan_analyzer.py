...
print(f"The number of loans in the is {number_of_loans}")

# What is the total of all loans?
# @TODO: Use the `sum` function to calculate the total of all loans in the list.
# Print the total value of the loans
loans_costs_sum = sum(loan_costs)
print(f"The total value of the loans is ${loans_costs_sum}")

# What is the average loan amount from the list?
# @TODO: Using the sum of all loans and the total number of loans, calculate the average loan price.
# Print the average loan amount
print(f"The average loan amount is ${loans_costs_sum / number_of_loans}")
...
print(f"The number of remaining months for the loan is {remaining_months}")
...
print(f"The Present Value for the loan is: ${round(present_value, 2)}")
...
output_path = Path(r".\Module1\inexpensive_loans.csv")
